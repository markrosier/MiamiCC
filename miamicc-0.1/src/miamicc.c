...
static dwSet_t functionList[] =
        {
            ...
            { "getHexnode1Input1", &getHexnode1Input1, boolFunctionPByteType, "Get State of Hexnode 1 Output 1", "Hexnode 1 Output 1", ""},
            { "getHexnode1Input2", &getHexnode1Input1, boolFunctionPByteType, "Get State of Hexnode 1 Output 2", "Hexnode 1 Output 2", ""},
            { "getHexnode1Input3", &getHexnode1Input1, boolFunctionPByteType, "Get State of Hexnode 1 Output 3", "Hexnode 1 Output 3", ""},
            { "getHexnode1Input4", &getHexnode1Input1, boolFunctionPByteType, "Get State of Hexnode 1 Output 4", "Hexnode 1 Output 4", ""},
            { "getHexnode1ADCInput5", &getHexnode1ADCInput5, boolFunctionPIntType, "Get 10 bit ADC Value of Hexnode 1 Output 5", "Hexnode 1 Output 5", ""},
            { "getHexnode1ADCInput6", &getHexnode1ADCInput6, boolFunctionPIntType, "Get 10 bit ADC Value of Hexnode 1 Output 6", "Hexnode 1 Output 6", ""},
            {  NULL, NULL,0}
        };
